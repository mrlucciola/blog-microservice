...
export const HOST_ADDR_MODERATION = `${HOSTNAMES.moderation.internal}`;
...
export const HOST_ADDR_POSTS_INTERNAL = `${HOSTNAMES.posts.internal}`;
export const HOST_ADDR_COMMENTS_EXTERNAL = `${HOSTNAMES.comments.external}`;
export const HOST_ADDR_COMMENTS_INTERNAL = `${HOSTNAMES.comments.internal}`;
export const HOST_ADDR_QUERY_EXTERNAL = `${HOSTNAMES.query.external}`;
export const HOST_ADDR_QUERY_INTERNAL = `${HOSTNAMES.query.internal}`;
